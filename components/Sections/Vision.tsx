    ...
    <section className="w-full overflow-hidden">
      ...
      <div className="bg-brand-orange text-white py-16 sm:py-20 md:py-32 relative w-full">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10 flex flex-col items-center">
          <Reveal>
            <h2 className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-8xl mb-8 md:mb-12 tracking-tighter">
              HOW WE OPERATE
            </h2>
          </Reveal>
          ...
          <Reveal delay={0.4}>
            <div className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-10 md:mt-16 space-y-3 md:space-y-4">
              <p>
                <span className="font-bold text-[#345C72]">Execution</span>{" "}
                follows.
              </p>
              <p>
                <span className="font-bold text-[#345C72]">Tracking</span> is
                constant.
              </p>
              <p>
                <span className="font-bold text-[#345C72]">Decisions</span> are
                data-led.
              </p>
            </div>
          </Reveal>
      ...
      {/* FINAL SLOGAN */}
      <div className="bg-[#F4F0EA] min-h-[40vh] flex items-center justify-center px-4 sm:px-6 py-16">
      ...
      "
          >
            If your marketing feels busy
            <br />
            but growth feels slow,
            <br />
            it’s time to <span className="text-[#345C72]">
              "manage it"
            </span>{" "}
            better.
          </h2>

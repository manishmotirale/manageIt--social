...
const Hero: React.FC = () => {
  ...
  "
      >
        ...
        <Reveal delay={0.2}>
          <h2 className="font-display text-[1.6rem] sm:text-[2.4rem] md:text-[4rem] lg:text-[4.5rem] text-brand-dark mt-4 mb-8 max-w-3xl">
      ...
      >
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          <div className="w-24 h-48 md:w-28 md:h-56 lg:w-36 lg:h-64 bg-brand-dark rounded-b-full shadow-xl md:-mt-20">
            <SquiggleVertical
              color="#FA934D"
          ...
          >
            <SquiggleVertical
              color="#204E62"
              className="mx-auto mt-28 md:scale-150"
            />
          </PillShape>
        </div>

        {/* COLUMN 2 */}
        <div className="flex flex-col gap-6 md:gap-8 mt-20">
          <PillShape
            color="#2B687F"
          ...
          >
            <SquiggleVertical
              color="#F4F0EA"
              className="mx-auto mt-32 md:scale-[2.5]"
            />
          </PillShape>
          ...
          <div className="w-24 h-32 md:w-28 md:h-40 lg:w-36 lg:h-48 bg-brand-orange rounded-t-full shadow-xl flex items-end justify-center pb-8">
            <TripleSquiggle className="md:scale-125" />
          </div>
        </div>
      </div>
    </section>
